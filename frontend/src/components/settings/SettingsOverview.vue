...
<style scoped>
.settings-overview{display:grid;gap:18px}.settings-health-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:14px}.settings-health-card{display:grid;grid-template-columns:44px minmax(0,1fr) auto;gap:9px 13px;align-items:center;min-height:132px;padding:18px;border:1px solid var(--border);border-radius:15px;background:var(--surface);color:var(--text);text-align:left;transition:border-color .2s,transform .2s,box-shadow .2s}.settings-health-card:hover{border-color:var(--accent);transform:translateY(-2px);box-shadow:0 12px 26px rgba(0,0,0,.2)}.settings-health-card>svg{width:22px;height:22px;padding:10px;box-sizing:content-box;border:1px solid var(--border);border-radius:11px;background:var(--surface-2);color:var(--accent)}.settings-health-card>div{display:grid;gap:5px;min-width:0}.settings-health-card div span{color:var(--muted);font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:.08em}.settings-health-card strong{font-size:15px;line-height:1.3}.settings-health-card small{overflow:hidden;color:color-mix(in srgb,var(--text) 68%,transparent);font-size:12px;line-height:1.4;text-overflow:ellipsis;white-space:nowrap}.health-state{grid-column:2/-1;justify-self:start;padding:5px 9px;border-radius:999px;font-size:10px;font-weight:700;background:var(--surface-2);color:var(--muted)}.health-state.active{color:var(--success);background:rgba(34,197,94,.1)}.health-state.incomplete{color:var(--accent);background:rgba(229,160,13,.1)}.configuration-progress{padding:20px}.configuration-progress .panel-head>div{display:grid;gap:4px}.configuration-progress progress{width:100%;height:10px}.configuration-progress p{margin-bottom:0;color:var(--muted);font-size:12px;line-height:1.5}@media(max-width:1024px){.settings-health-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:640px){.settings-health-grid{grid-template-columns:1fr;gap:11px}.settings-health-card{grid-template-columns:42px minmax(0,1fr) auto;min-height:112px;padding:15px}.settings-health-card>svg{width:20px;height:20px}.settings-health-card strong{font-size:14px}.settings-health-card small{white-space:normal}.configuration-progress{padding:16px}.configuration-progress .panel-head{align-items:flex-start}.configuration-progress .panel-head strong{font-size:18px}}
</style>
