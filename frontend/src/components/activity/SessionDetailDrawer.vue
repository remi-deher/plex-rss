...
function networkLabel(item){if(item.geo_status==='local')return 'local';const scope=item.location==='lan'?'Local':item.location==='wan'?'Distant':null;const place=[item.geo_city,item.geo_country_code||item.geo_country].filter(Boolean).join(', ');return [scope,place,item.address].filter(Boolean).join(' · ')||'Adresse masquée'}
</script>

<style scoped>
.session-hero{display:flex;gap:18px;align-items:center;margin:8px 0 20px}.session-hero>div:last-child{display:grid;gap:5px;min-width:0}.session-hero h3{margin:4px 0 0;font-size:19px}.session-hero p,.session-hero span{margin:0;color:color-mix(in srgb,var(--text) 72%,transparent);font-size:12px}.session-progress{display:grid;gap:8px;padding:14px;border:1px solid var(--border);border-radius:12px;background:var(--surface-2)}.session-progress>div:first-child{display:flex;justify-content:space-between}.session-progress span,.session-progress small{color:color-mix(in srgb,var(--text) 70%,transparent);font-size:11px}.progress-track{height:6px;overflow:hidden;border-radius:99px;background:rgba(255,255,255,.1)}.progress-track i{display:block;height:100%;border-radius:inherit;background:var(--accent)}.session-kpis{display:grid;grid-template-columns:repeat(3,1fr);gap:9px;margin-top:10px}.session-kpis article{display:grid;gap:4px;padding:12px;border:1px solid var(--border);border-radius:10px;background:var(--surface-2)}.session-kpis span,.session-kpis small{color:color-mix(in srgb,var(--text) 68%,transparent);font-size:10px}.session-kpis strong{font-size:14px}.stream-route{margin-top:22px}.stream-route>div{display:grid;grid-template-columns:minmax(0,1fr) 28px minmax(0,1fr) 28px minmax(0,1fr);align-items:center;margin-top:8px}.stream-route article{display:flex;align-items:center;gap:8px;min-width:0;padding:10px;border:1px solid var(--border);border-radius:10px;background:var(--surface-2)}.stream-route article>svg{width:17px;color:var(--accent)}.stream-route article span{display:grid;min-width:0}.stream-route small{color:color-mix(in srgb,var(--text) 64%,transparent);font-size:9px;text-transform:uppercase}.stream-route strong{overflow:hidden;font-size:11px;text-overflow:ellipsis;white-space:nowrap}.stream-route i{height:2px;background:var(--border)}.stream-route i.warning{background:#fb923c}.session-detail-section{margin-top:22px}.session-detail-section dl{display:grid;grid-template-columns:1fr 1fr;margin:8px 0 0;border:1px solid var(--border);border-radius:12px}.session-detail-section dl>div{display:grid;gap:5px;padding:13px;border-bottom:1px solid var(--border)}.session-detail-section dl>div:nth-child(odd){border-right:1px solid var(--border)}.session-detail-section dl>div:nth-last-child(-n+2){border-bottom:0}.session-detail-section dt{color:color-mix(in srgb,var(--text) 66%,transparent);font-size:10px;text-transform:uppercase}.session-detail-section dd{margin:0;font-size:13px;line-height:1.4}.session-id{overflow:hidden;color:var(--muted);font-family:monospace;text-overflow:ellipsis;white-space:nowrap}.session-address{font-variant-numeric:tabular-nums}@media(max-width:620px){.session-kpis{grid-template-columns:1fr}.stream-route>div{grid-template-columns:1fr}.stream-route i{width:2px;height:14px;margin:auto}.stream-route article{width:100%}}@media(max-width:520px){.session-hero{align-items:flex-start}.session-detail-section dl{grid-template-columns:1fr}.session-detail-section dl>div,.session-detail-section dl>div:nth-child(odd){border-right:0;border-bottom:1px solid var(--border)}.session-detail-section dl>div:last-child{border-bottom:0}}
</style>
