...
dl{display:grid;grid-template-columns:repeat(4,1fr);margin:0}dl>div{display:grid;gap: var(--space-1);padding:10px 12px;border-right:1px solid var(--border)}dl>div:last-child{border:0}dt{color:var(--muted);font-size:var(--fs-xs);}dd{overflow:hidden;margin:0;font-size:var(--fs-xs);text-overflow:ellipsis;white-space:nowrap}
