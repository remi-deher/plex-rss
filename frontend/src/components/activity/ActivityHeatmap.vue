...
<style scoped>
.panel-head>strong{color:var(--accent);font-size:11px}.heatmap-scroll{margin-top:14px;overflow-x:auto}.heatmap-grid{display:grid;grid-template-columns:30px repeat(24,minmax(14px,1fr));gap:3px;min-width:600px}.heatmap-grid small{color:var(--muted);font-size:7px;text-align:center}.heatmap-grid>strong{align-self:center;color:var(--muted);font-size:8px}.heatmap-grid i{aspect-ratio:1;border-radius:3px;background:var(--accent)}.heatmap-mobile{display:none}.heatmap-panel footer{display:flex;align-items:center;justify-content:flex-end;gap:4px;margin-top:9px;color:var(--muted);font-size:8px}.heatmap-panel footer i{width:10px;height:10px;border-radius:2px;background:var(--accent)}@media(max-width:640px){.heatmap-scroll,.heatmap-panel footer{display:none}.heatmap-mobile{display:grid;gap:12px;margin-top:14px}.heatmap-mobile article{display:grid;grid-template-columns:1fr auto;gap:5px}.heatmap-mobile strong,.heatmap-mobile span{font-size:12px}.heatmap-mobile span{color:var(--muted);font-variant-numeric:tabular-nums}.heatmap-mobile i{grid-column:1/-1;height:12px;border-radius:99px;background:linear-gradient(90deg,var(--accent),#fbbf24)}}
</style>
