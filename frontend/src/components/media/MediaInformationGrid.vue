...
@media(min-width:1025px){.information-card{padding:17px;gap:15px}.information-card>header span{font-size:11px}.information-card>header strong{font-size:16px}.information-card dt,.information-card dd,.information-note{font-size:13px}.compact-list strong{font-size:13px}.compact-list small,.empty-copy{font-size:12px}}
</style>
