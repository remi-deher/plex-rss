...
<script setup>
import { onMounted,ref } from 'vue';import { Check,KeyRound,RefreshCw,ScanSearch,Trash2,WandSparkles } from '@lucide/vue';import { api } from '@/api';import SettingsCard from './settings/SettingsCard.vue';import ConfirmModal from './ConfirmModal.vue';import { useConfirm } from '@/composables/useConfirm';
