...
<style scoped>
.user-metrics{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap: var(--space-2)}.user-metrics button{display:flex;align-items:flex-start;gap: var(--space-2);padding:12px;border:1px solid var(--border);border-radius:var(--radius-md);background:var(--surface);color:var(--text);text-align:left}.user-metrics button:hover,.user-metrics button.active{border-color:var(--accent);background:var(--surface-2)}.user-metrics svg{width:18px;color:var(--muted)}.user-metrics div{display:grid;gap: var(--space-1)}.user-metrics span{color:var(--muted);font-size:var(--fs-xs);}.user-metrics strong{font-size:var(--fs-lg)}.user-metrics small{color:var(--muted);font-size:var(--fs-xs)}@media(max-width:800px){.user-metrics{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:480px){.user-metrics{display:flex;overflow-x:auto;scroll-snap-type:x mandatory}.user-metrics button{min-width:150px;scroll-snap-align:start}}
@media(min-width:721px){:deep(.users-filter-bar){display:flex;flex-wrap:nowrap;align-items:center;gap: var(--space-2);overflow-x:auto}:deep(.users-filter-bar .ui-filter-primary){flex:1 1 200px;min-width:160px}:deep(.users-filter-bar .ui-filter-primary .search){min-height:46px}:deep(.users-filter-bar .ui-filter-desktop){display:flex;flex-wrap:nowrap;align-items:center;gap: var(--space-2);flex:0 0 auto}:deep(.users-filter-bar .ui-filter-desktop select){width:auto;min-width:120px;flex:0 0 auto}:deep(.users-filter-bar .ui-filter-reset){min-height:40px;white-space:nowrap;flex:0 0 auto}}
</style>
