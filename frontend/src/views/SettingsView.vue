        ...
        <div v-else class="webhook-list">
          <div v-for="svc in ['plex', 'radarr', 'sonarr']" :key="svc" class="webhook-item">
            ...
            <div class="webhook-url">
              <input type="text" readonly :value="`${baseUrl}/api/webhook/${svc}?secret=${form.webhook_secret}`">
