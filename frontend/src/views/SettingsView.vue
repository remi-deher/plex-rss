...
<style scoped>
.settings-section-select{display:none;gap:7px;color:var(--muted);font-size:12px;font-weight:650}.settings-section-select select{width:100%;min-height:44px}
.settings-search{position:relative;display:flex;align-items:center;gap:10px;width:min(100%,620px);min-height:48px;padding:10px 14px;border:1px solid var(--border);border-radius:12px;background:var(--surface)}.settings-search:focus-within{border-color:var(--accent);box-shadow:0 0 0 3px color-mix(in srgb,var(--accent) 12%,transparent)}.settings-search>svg{flex:none;width:18px;color:var(--muted)}.settings-search>input{width:100%;border:0;background:transparent;outline:0;color:var(--text);font-size:14px}.settings-search-results{position:absolute;z-index:30;top:calc(100% + 7px);left:0;right:0;display:grid;padding:7px;border:1px solid var(--border);border-radius:11px;background:var(--surface);box-shadow:0 12px 28px rgba(0,0,0,.3)}.settings-search-results button{display:flex;justify-content:space-between;min-height:44px;padding:10px;border:0;border-radius:8px;background:transparent;color:var(--text);font-size:13px;text-align:left}.settings-search-results button:hover{background:var(--surface-2)}.settings-search-results span,.settings-search-results p{color:var(--muted);font-size:11px}
@media(max-width:1024px){.settings-section-select{display:grid;max-width:620px}}
@media(max-width:640px){.settings-section-select{position:sticky;top:8px;z-index:18;padding:12px;background:color-mix(in srgb,var(--surface) 94%,transparent);border:1px solid var(--border);border-radius:12px;box-shadow:0 8px 24px rgba(0,0,0,.18);backdrop-filter:blur(14px)}.settings-search{width:100%}}
</style>
