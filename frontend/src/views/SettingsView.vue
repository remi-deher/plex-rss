...
@media(max-width:640px){.settings-section-select{position:sticky;top:8px;z-index:18;padding:12px;background:color-mix(in srgb,var(--surface) 94%,transparent);border:1px solid var(--border);border-radius:var(--radius-md);box-shadow:0 8px 24px rgba(0,0,0,.18);backdrop-filter:blur(14px)}.settings-search{width:100%}}
</style>
